package com.example.finedust.data.network.previous
...
interface PreNearbyParadidymisAPI {
    ...
    companion object {
        ...
        fun create(): PreNearbyParadidymisAPI {
...
//            말그대로 정보를 중간에 가져오는 역할
            ...
            return Retrofit.Builder()
                ...
                .build()
                .create(PreNearbyParadidymisAPI::class.java)
